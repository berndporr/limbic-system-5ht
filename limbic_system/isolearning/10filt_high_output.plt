...
#    
set terminal postscript eps noenhanced color colortext \
   solid dashlength 1.0 linewidth 1.0 defaultplex \
   palfuncparam 2000,0.003 \
   butt "Helvetica" 14
set output '10filt_high_output1.eps'
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xrange [ * : 10000] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "" 0.000000,0.000000  font ""
set y2label "" 0.000000,0.000000  font ""
set yrange [ * : 2 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
plot "10filt_high_output.dat" using 1:2 w l
#, "10filt_high_weights.dat" using 1:13 w l, "10filt_high_weights.dat" using 1:14 w l, "10filt_high_weights.dat" using 1:15 w l, "10filt_high_weights.dat" using 1:16 w l, "10filt_high_weights.dat" using 1:17 w l, "10filt_high_weights.dat" using 1:18 w l, "10filt_high_weights.dat" using 1:19 w l, "10filt_high_weights.dat" using 1:20 w l, "10filt_high_weights.dat" using 1:21 w l
#    EOF
